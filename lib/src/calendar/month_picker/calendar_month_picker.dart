...
typedef CalendarMonthPickerGetDayStyle = CalendarMonthPickerDayStyle? Function(DateTime day,
    {required bool isCurrentDay, required bool isSelectedDay, required bool isDisabledDay, required CalendarMonthPickerDayStyle style});
    ...
    while (day < daysInMonth) {
      ...
      if (day < 1) {
        ...
        if (widget.getDateStyle != null) {
          style = widget.getDateStyle!(date, isCurrentDay: isCurrentDay, isSelectedDay: isSelectedDay, isDisabledDay: isDisabledDay, style: style) ?? style;
        }
